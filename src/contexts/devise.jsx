...
export const DeviseProvider = props => {
    const [screenSize, setDimensions] = useState({ width: window.innerWidth, height: window.innerHeight });
    const width = screenSize.width; const height = screenSize.height;
    const isMobile = width < 700; const isTablet = width >= 700 && width <= 1024; const isDesktop = width > 1024;
